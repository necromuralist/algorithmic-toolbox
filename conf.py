...
BLOG_TITLE = "Algorithmic Toolbox"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://github.com/necromuralist/algorithmic_toolbox/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "necromuralist@protonmail.com"
BLOG_DESCRIPTION = "Notes as I study algorithms and data structures."  # (translatable)
